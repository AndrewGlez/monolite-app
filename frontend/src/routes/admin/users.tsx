...
export const Route = createFileRoute('/admin/users')({ component: UserListPage })
      ...
      <AdminGuard>
        <div className="min-h-screen bg-gray-50">
          <nav className="bg-white shadow-sm p-4 flex justify-between items-center">
            ...
            <Link to="/profile" className="text-sm text-gray-600 hover:text-blue-600">Mi Perfil</Link>
          </nav>
